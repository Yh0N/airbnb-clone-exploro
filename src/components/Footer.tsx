    ...
    <footer className="bg-neutral-100 border-t border-neutral-200 mt-12">
      ...
      <div className="max-w-[2520px] mx-auto px-4 sm:px-6 md:px-10 xl:px-20">
        <div className="py-10 border-b border-neutral-200">
          ...
          >
            <h3 className="text-[22px] font-bold text-neutral-800">
          ...
          {showInspiration && (
            <>
              {/* Tabs de inspiración */}
              <div className="flex gap-6 border-b border-neutral-200 mb-6 overflow-x-auto" style={{ scrollbarWidth: 'none' }}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {inspirationData[activeInspirationTab]?.map((item, idx) => (
                  <Link
                    ...
                    className="group"
                  >
                    <p className="text-sm font-semibold text-neutral-800 group-hover:underline">
                      {item.name}
                    </p>
      ...
      <div className="max-w-[2520px] mx-auto px-4 sm:px-6 md:px-10 xl:px-20 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Columna 1 */}
          <div>
            <h4 className="font-bold text-sm text-neutral-800 mb-4">Asistencia</h4>
            <ul className="space-y-3">
              <li>
                <span className="text-sm text-neutral-600 hover:text-neutral-800 hover:underline transition-colors cursor-pointer">
                  Centro de ayuda
                </span>
              </li>
              <li>
          ...
          {/* Columna 2 */}
          <div>
            <h4 className="font-bold text-sm text-neutral-800 mb-4">Comunidad</h4>
            <ul className="space-y-3">
              <li>
                <span className="text-sm text-neutral-600 hover:text-neutral-800 hover:underline transition-colors cursor-pointer">
          ...
          {/* Columna 3 */}
          <div>
            <h4 className="font-bold text-sm text-neutral-800 mb-4">Acerca de</h4>
            <ul className="space-y-3">
              <li>
                <span className="text-sm text-neutral-600 hover:text-neutral-800 hover:underline transition-colors cursor-pointer">
                  Sala de prensa
      ...
      <div className="border-t border-neutral-200">
        <div className="max-w-[2520px] mx-auto px-4 sm:px-6 md:px-10 xl:px-20 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 flex-wrap text-sm text-neutral-600">
            ...
            <div className="flex items-center gap-6">
              <button className="flex items-center gap-2 text-sm font-semibold text-neutral-800 hover:underline">
                <Globe className="w-4 h-4" />
                Español (CO)
              </button>
              <span className="text-sm font-semibold text-neutral-800">$ COP</span>
              {/* Social icons */}
