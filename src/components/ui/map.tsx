...
// Check document class for theme (works with next-themes, tailwind, etc.)
function getDocumentTheme(): Theme | null {
  if (typeof document === "undefined") return null;
  if (document.documentElement.classList.contains("dark")) return "dark";
  // Si no tiene la clase dark, forzamos light mode para que coincida con la app
  return "light";
}

// Get system preference (solo se usa si no hay window/document)
